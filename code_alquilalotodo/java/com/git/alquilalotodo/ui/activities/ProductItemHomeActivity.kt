    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (prod != null) {
            ...
            db.collection("usuarios").document(prod.userId).get().addOnSuccessListener {
                val username = it.getString("nombre")?: "Usuario"
                val usuarioApellidos = it.getString("apellidos")?: "Sin Apellidos"
                binding.prodItemNombreUsuario.text =  username+ " " + usuarioApellidos
